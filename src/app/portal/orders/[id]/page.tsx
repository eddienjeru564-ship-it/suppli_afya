    ...
    <div className="grid max-w-2xl gap-6">
      ...
      <div>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Pill tone={o.status} />
          {o.source === "shop" && <span className="rounded-full bg-sage-soft px-2.5 py-0.5 text-[0.75rem] font-semibold text-forest">From your shop{o.ref ? ` · ${o.ref}` : ""}</span>}
        </div>
      ...
      {o.source === "shop" && (o.delivery || o.customer_note) && (
        <Card className="grid gap-2 p-5 text-[0.93rem]">
          {o.delivery && (
            <p>
              ...
              <span className="text-ink-soft">{o.delivery.fulfilment === "pickup" ? "They'll collect from you." : o.delivery.address}</span>
            </p>
          )}
